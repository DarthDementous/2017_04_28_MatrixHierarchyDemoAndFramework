...
#define	DEFAULT_RESTITUTION		.65f		// Global bounce on unit variables (1.0 = bounce forever with collisions)
...
protected:
	...
	Vector4<float>									cameraReference = Vector4<float>(0, 300, 600, 1);    /*Offset position of the camera*/           
